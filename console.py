...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, arg):
        ...
        # TODO: makes the common check a property
        if arg == "":
    ...
    def do_destroy(self, arg):
        ...
        try:
            ...
            if arg.count(' ') == 0:
                print("** instance id mssing **")
            elif arg.count(' ') > 1:
                print("** too many argument (2 arguments required) **")
            else:
                print(e)
    ...
    def do_all(self, arg):
        ...
        if arg == "":
            ...
            try:
                model = models.classes[arg]
                resp = []
                for l in model.storage.all().values():
                    if type(l) == model:
